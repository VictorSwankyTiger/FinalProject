...
void Mode_draw(Scene *self)
{
    ...
    al_draw_text(Obj->font, al_map_rgb(255, 255, 255), Obj->title_x-300, Obj->title_y, ALLEGRO_ALIGN_CENTRE, "Press \"V\" to select");
    ...
    al_draw_text(Obj->font, al_map_rgb(255, 255, 255), Obj->title_x+300, Obj->title_y, ALLEGRO_ALIGN_CENTRE, "Press \"B\" to selcet");
