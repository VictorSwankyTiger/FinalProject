...
Game *New_Game()
{
    ...
    game->title = "Final Project Group30";
    game->display = NULL;
    game->game_init(game);
    return game;
}
...
void game_init(Game *self)
{
    ...
    ALLEGRO_BITMAP *icon = al_load_bitmap("assets/image/icon_test.jpg"); //("assets/image/icon.jpg");
...
void game_draw(Game *self)
{
    ...
    al_clear_to_color(al_map_rgb(100, 0, 0)); //(100, 100, 100)
    scene->Draw(scene);
    al_flip_display();
}
